...
export const BookingForm = ({ packageInfo }: BookingFormProps) => {
  ...
  return (
    <Dialog>
      <DialogContent className="p-0 sm:p-4 md:p-6 max-w-3xl mx-auto w-full">
        <DialogHeader className="text-center mb-4 sm:mb-6">
          <DialogTitle className="text-lg sm:text-xl md:text-2xl font-bold">Book Your Cleaning Service</DialogTitle>
          {packageInfo && (
