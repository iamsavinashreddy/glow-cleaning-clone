        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/packages" className="text-gray-300 hover:text-white transition-colors duration-300">Packages</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">1-800-CLEAN</span>
              </li>
              <li className="flex items-start">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-300">Monday - Friday: 8:00 AM - 8:00 PM</li>
              <li className="text-gray-300">Saturday: 9:00 AM - 6:00 PM</li>
              <li className="text-gray-300">Sunday: 10:00 AM - 4:00 PM</li>
            </ul>
          </div>
        </div>
